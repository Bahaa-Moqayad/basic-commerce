                                    ...
                                    @foreach ($carts as $cart)
                                        <tr>
                                            <td class="product-thumbnail"><a
                                                    href="{{ route('site.product', $cart->product_id) }}"><img
                                                        src="{{ asset('uploads/images/' . $cart->product->image) }}"
                                            ...
                                            <td class="product-quantity"><input type="number"
                                                    name="new_qty[{{ $cart->id }}]" value="{{ $cart->qty }}" />
                                            </td>
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <div class="cart_totals">
                                    ...
                                    <div class="wc-proceed-to-checkout">
                                        <a href="{{ route('site.checkout') }}">Proceed to Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
