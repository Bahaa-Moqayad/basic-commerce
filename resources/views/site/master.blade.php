        ...
        <div class="shopping__cart">
            <div class="shopping__cart__inner">
                    ...
                    @foreach ($carts as $cart)
                        ...
                        <div class="shp__single__product">
                            ...
                            <div class="shp__pro__details">
                                <h2><a
                                        href="{{ route('site.product', $cart->product_id) }}">{{ $cart->product->name }}</a>
                                </h2>
                ...
                <ul class="shoping__total">
                    ...
                    <li class="total__price">${{ number_format($total, 2) }}</li>
                </ul>
                <ul class="shopping__btn">
                    <li><a href="{{ route('site.cart') }}">View Cart</a></li>
                    <li class="shp__checkout"><a href="{{ route('site.checkout') }}">Checkout</a></li>
                </ul>
            </div>
        </div>
        <!-- End Cart Panel -->
                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="{{ route('site.shop') }}">Shop</a>
                                        <ul class="dropdown mega_dropdown">
                                            ...
                                            <li><a class="mega__title" href="{{ route('site.shop') }}">shop
                                                    layout</a>
                                                <ul class="mega__item">
                                                    <li><a href="{{ route('site.shop') }}">default shop</a></li>
                                                </ul>
                                            </li>
                                            <!-- End Single Mega MEnu -->
                                            <!-- Start Single Mega MEnu -->
                                            <li><a class="mega__title" href="{{ route('site.shop') }}">product
                                                    details layout</a>
                                                <ul class="mega__item">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                ...
                                <ul class="footer__menu">
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="{{ route('site.shop') }}">Product</a></li>
                                    <li><a href="contact.html">Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="modal-product">
                            ...
                            <div class="
                                    ...
                                    <div class="quick-desc">
                                        ...
                                        materials. Its sleek geometry and
                                    ...
                                    <div class="select__size">
                                        <h2>Select size</h2>
                                        <ul class="color__list">
                                            <li class="l__size"><a title="L" href="#">L</a>
                                            </li>
                                            <li class="m__size"><a title="M" href="#">M</a>
                                            </li>
                                            <li class="s__size"><a title="S" href="#">S</a>
                                            </li>
